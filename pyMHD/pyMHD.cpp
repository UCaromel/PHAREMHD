...
py::array_t<double>
convert_to_numpy(const std::vector<std::vector<double>> &vec) {
  size_t ny = vec.size();
...
convert_from_numpy(py::array_t<double> numpy_array) {
  auto buffer = numpy_array.request();
  double *ptr = static_cast<double *>(buffer.ptr);
...
PYBIND11_MODULE(pyMHD, m) {
  py::class_<PrimitiveVariables>(m, "PrimitiveVariables")
      ...
      .def("assign", [](PrimitiveVariables &self,
                        const PrimitiveVariables &other) { self = other; });
  ...
  py::class_<Consts>(m, "Consts")
      .def(py::init<double, double, double, double>(),
           py::arg("sigmaCFL") = 0.8, py::arg("gam") = 5.0 / 3.0,
           py::arg("eta") = 0.0, py::arg("nu") = 0.0);

  m.def("PhareMHD", &PhareMHD, py::arg("primvar0"), py::arg("resultdir"),
        py::arg("nghost"), py::arg("boundaryconditions"),
        py::arg("reconstruction"), py::arg("slopelimiter"),
        py::arg("riemannsolver"), py::arg("constainedtransport"),
        py::arg("timeintegrator"), py::arg("Dx"), py::arg("Dy"),
        py::arg("FinalTime"), py::arg("Dt") = 0.0, py::arg("Consts") = Consts(),
        py::arg("OptionalPhysics") = Off,
        py::arg("dumpvariables") = Conservative, py::arg("dumpfrequency") = 1);
  ...
  /*
      py::class_<ConservativeVariables>(m, "ConservativeVariables")
          ...
          .def_property("rho",
              [](ConservativeVariables& self) { return
     convert_to_numpy(self.rho); },
              [](ConservativeVariables& self, py::array_t<double> array) {
     self.rho = convert_from_numpy(array); }) .def_property("rhovx",
              [](ConservativeVariables& self) { return
     convert_to_numpy(self.rhovx); },
              [](ConservativeVariables& self, py::array_t<double> array) {
     self.rhovx = convert_from_numpy(array); }) .def_property("rhovy",
              [](ConservativeVariables& self) { return
     convert_to_numpy(self.rhovy); },
              [](ConservativeVariables& self, py::array_t<double> array) {
     self.rhovy = convert_from_numpy(array); }) .def_property("rhovz",
              [](ConservativeVariables& self) { return
     convert_to_numpy(self.rhovz); },
              [](ConservativeVariables& self, py::array_t<double> array) {
     self.rhovz = convert_from_numpy(array); }) .def_property("Bx",
              [](ConservativeVariables& self) { return
     convert_to_numpy(self.Bx); },
              [](ConservativeVariables& self, py::array_t<double> array) {
     self.Bx = convert_from_numpy(array); }) .def_property("By",
              [](ConservativeVariables& self) { return
     convert_to_numpy(self.By); },
              [](ConservativeVariables& self, py::array_t<double> array) {
     self.By = convert_from_numpy(array); }) .def_property("Bz",
              [](ConservativeVariables& self) { return
     convert_to_numpy(self.Bz); },
              [](ConservativeVariables& self, py::array_t<double> array) {
     self.Bz = convert_from_numpy(array); }) .def_property("Etot",
              [](ConservativeVariables& self) { return
     convert_to_numpy(self.Etot); },
              [](ConservativeVariables& self, py::array_t<double> array) {
     self.Etot = convert_from_numpy(array); })
          ...
          .def(py::self - py::self)
          .def(py::self + py::self)
          .def("assign", [](ConservativeVariables& self, const
     ConservativeVariables& other) { self = other;
          });
      ...
      py::class_<ReconstructedValues>(m, "ReconstructedValues")
          ...
          .def(py::self * double())
          .def(double() * py::self)
          .def("assign", [](ReconstructedValues& self, const
     ReconstructedValues& other) { self = other;
          });
      ...
      py::class_<ConstrainedTransport>(m, "ConstrainedTransport")
          ...
          .def(py::init<const ConservativeVariables&, double, double, double,
     int>());
...
PYBIND11_MODULE(pyMHD, m)
{
    // expose dict add function per template type to force casts/error when used
from python
