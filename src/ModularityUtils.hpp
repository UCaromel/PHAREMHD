...
typedef std::pair<std::vector<std::vector<double>>, std::vector<std::vector<double>>> (*CTFunction)(const ConservativeVariablesCC&, double, double, double, int, Reconstruction, Slope);
